...
These sections should be executed in order. Note also that all the above analyses are performed with a **MacBook Pro (OS X El Capitan, version 10.11.6)**, unsing a `R` version **3.3.2**.
